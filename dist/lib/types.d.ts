...
export type ChainedMoney = {
     ...
     */
    min: (m1: Money | ChainedMoney, ...m: (Money | ChainedMoney)[]) => ChainedMoney;
    /**
     * Return the largest of multiple Money objects
     * @example max(m1, m2, m3, ...) -> m3
     */
    max: (m1: Money | ChainedMoney, ...m: (Money | ChainedMoney)[]) => ChainedMoney;
    /**
     ...
     */
    add: (m1: Money | ChainedMoney, ...m: (Money | ChainedMoney)[]) => ChainedMoney;
    /**
     * Subtract two Money objects
     * TODO: add support for multiple arguments to return diff of all (subtract(m1, m2, m3, ...)
     * @example m1.subtract(m2) -> m3
     */
    subtract: (m1: Money | ChainedMoney, ...m: (Money | ChainedMoney)[]) => ChainedMoney;
    /**
    ...
    format: (ops?: {
        ...
        /**
         * default: true; Whether to use grouping separators, such as thousands separators or thousand/lakh/crore separators.
         */
        useGrouping?: boolean;
    }) => string;
    /**
     ...
     */
    parse: (s: string, currency: string, locale?: string, decimalSeparator?: "." | ",") => ChainedMoney;
    /**
